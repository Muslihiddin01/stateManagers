...
const Jotai = () => {
  let [data] = useAtom(dataAtom);
  let [, getData] = useAtom(getDataAtom);
  let [, addData] = useAtom(addDataAtom);
  let [, deleteData] = useAtom(deleteDataAtom);
  let [, editData] = useAtom(editDataAtom);
  let [, addImage] = useAtom(addImageAtom);
  let [, deleteImages] = useAtom(deleteImageAtom);
  useEffect(() => {
    getData();
  }, []);
